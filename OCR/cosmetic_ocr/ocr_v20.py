...
class IngredientDatabase:
    ...
    def __init__(self):
        self.ingredients = [
            ...
            "Ferulic Acid", "Salicylic Acid", "Linoleic Acid", "Linolenic Acid",
            "Ascorbyl Glucoside", "Acetyl Glutamine",
            
            # Peptides
            "Palmitoyl Tripeptide-1", "Palmitoyl Tetrapeptide-7",
            "SH-Polypeptide-1", "SH-Polypeptide-9", "SH-Polypeptide-11",
            "SH-Oligopeptide-1", "SH-Oligopeptide-2",
            "Copper Palmitoyl Heptapeptide-14", "Heptapeptide-15 Palmitate",
            ...
            "Nymphaea Odorata Root Extract", "Symphytum Officinale Root Cell Extract",
            ...
            "Cetearyl Olivate", "Sorbitan Olivate", "Coconut Alkanes",
            "Sodium PCA", "Lecithin", "Isomalt",
            "Sodium Anisate", "Xanthan Gum", "Carbomer",
            "Polysorbate 20", "Propanediol", "Polyvinyl Alcohol",
        ]
...
class CosmeticOCRSimple:
    ...
    def simple_parse(self, text: str) -> List[str]:
        ...
        """
        # SIMPLE: Find the colon after "ingredients" word and start from there
        # Handles: "INGREDIENTS:", "PIGREDIENTS:", "Ingredients :", etc.
        colon_pos = text.find(':')
        if colon_pos > 0 and colon_pos < 100:  # Colon in first 100 chars (likely ingredients label)
            text = text[colon_pos + 1:].lstrip()
    ...
    def smart_filter_ingredients(self, candidates: List[str]) -> List[str]:
        ...
        bad_keywords = [
            ...
            'patent', 'manufacture', 'batch', 'exp', 'mfg', 'directions',
        ...
        for i, item in enumerate(candidates, 1):
            ...
            if matches_pattern or close_to_known or len(item) >= 6:  # Lowered from 8 to 6
